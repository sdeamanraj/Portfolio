      ...
      <div className=" container mx-auto pt-5 h-[750px] md:h-[100vh] md:flex-col-reverse sm:h-[780px]  flex sm:flex-col-reverse sm:pt-0 ">
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          ...
          <div data-aos="fade-up" className="buttons flex gap-5">
            ...
            <a
              href="https://drive.google.com/file/d/195XLfLih06P8Q8kSibBDk-7fgTxzRwDM/view"
          ...
          <div className="icons flex mt-5">
            ...
            >
              <li>
                <a href="https://github.com/sdeamanraj" target="_blank">
                  {" "}
                  <AiFillGithub className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125" />{" "}
                </a>
              </li>
              <li>
                <a href="https://linkedin.com/in/sdeamanraj" target="_blank">
                  {" "}
                  <FaLinkedinIn className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125 " />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/i_aman_raj/" target="_blank">
                  {" "}
